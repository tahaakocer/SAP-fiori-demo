		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Demo",
									"targetURL": "#comsolviademo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsolviademo-display": {
								"semanticObject": "comsolviademo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.solvia.demo",
									"url": sap.ui.require.toUrl("com/solvia/demo")
								}
							}
						}
					}
